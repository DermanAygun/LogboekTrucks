...
class srcApp_KernelDevDebugContainerUrlGenerator extends Symfony\Component\Routing\Generator\UrlGenerator
{
    ...
    public function __construct(RequestContext $context, LoggerInterface $logger = null, string $defaultLocale = null)
    {
        ...
        'logboek_index' => [[], ['_controller' => 'App\\Controller\\LogboekController::index'], [], [['text', '/logboek/']], [], []],
        'logboek_new' => [[], ['_controller' => 'App\\Controller\\LogboekController::new'], [], [['text', '/logboek/new']], [], []],
        'logboek_show' => [['id'], ['_controller' => 'App\\Controller\\LogboekController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/logboek']], [], []],
        'logboek_edit' => [['id'], ['_controller' => 'App\\Controller\\LogboekController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true], ['text', '/logboek']], [], []],
        'logboek_delete' => [['id'], ['_controller' => 'App\\Controller\\LogboekController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/logboek']], [], []],
        'truck_index' => [[], ['_controller' => 'App\\Controller\\TruckController::index'], [], [['text', '/truck/']], [], []],
        'truck_new' => [[], ['_controller' => 'App\\Controller\\TruckController::new'], [], [['text', '/truck/new']], [], []],
        'truck_show' => [['id'], ['_controller' => 'App\\Controller\\TruckController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/truck']], [], []],
        'truck_edit' => [['id'], ['_controller' => 'App\\Controller\\TruckController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true], ['text', '/truck']], [], []],
        'truck_delete' => [['id'], ['_controller' => 'App\\Controller\\TruckController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/truck']], [], []],
