...
// Returns the private 'App\Repository\LogboekRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\LogboekRepository.php';

return $this->privates['App\Repository\LogboekRepository'] = new \App\Repository\LogboekRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
