...
// Returns the private 'App\Repository\TruckRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TruckRepository.php';

return $this->privates['App\Repository\TruckRepository'] = new \App\Repository\TruckRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
